/*
 * File: _coder_CarDoorPhm_DataAnalysis_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "CarDoorPhm_DataAnalysis",           /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static const mxArray *emlrt_marshallOut(const int8_T u[17]);
 ...
 * Return Type  : void
 */
void CarDoorPhm_DataAnalysis_api(const mxArray * const prhs[1], int32_T nlhs,
  const mxArray *plhs[1])
{
  int8_T (*M)[17];
  ...
  M = (int8_T (*)[17])mxMalloc(sizeof(int8_T [17]));
  ...
  CarDoorPhm_DataAnalysis(Data, *M);
 ...
 * Return Type  : void
 */
void CarDoorPhm_DataAnalysis_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  CarDoorPhm_DataAnalysis_xil_terminate();
}
 ...
 * Return Type  : void
 */
void CarDoorPhm_DataAnalysis_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void CarDoorPhm_DataAnalysis_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_CarDoorPhm_DataAnalysis_api.c
 *
 * [EOF]
 */
